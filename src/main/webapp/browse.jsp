...
<body style="font-family:Arial;font-size:20px;">
	...
	<br><br>
	     <c:choose>
				   ...
				   <c:forEach var = "book" items="${books}">
				     <tr>
					   ...
					   <td style="color:gray;">
						 ...
						 <br><br>
						 <a href = "<%=request.getContextPath()%>/bookmark/save?bid=${book.getId()}" style="font-size:18px;color:#0058A6;font-weight:bold;text-decoration:none">Save</a>
					   </td>
					  </tr>
					  <tr>
			     	    <td>&nbsp;</td>
	      ...
	      <c:otherwise>
	         <br><br>
       	     <span style="font-size: 24px;color: #333333;margin:400px;">No items to show!</span>
	      </c:otherwise>
